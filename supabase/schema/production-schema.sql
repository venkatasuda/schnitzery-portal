...
CREATE TABLE attendance_corrections (
	...
	created_at timestamptz DEFAULT now() NOT NULL,
	CONSTRAINT attendance_corrections_pkey PRIMARY KEY (id),
	CONSTRAINT attendance_corrections_attendance_log_id_fkey FOREIGN KEY (attendance_log_id) REFERENCES attendance_logs(id) ON DELETE SET NULL,
	CONSTRAINT attendance_corrections_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE,
	CONSTRAINT attendance_corrections_user_id_fkey FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE
);
CREATE INDEX idx_corrections_branch ON public.attendance_corrections USING btree (branch_id, status);
CREATE INDEX idx_corrections_user ON public.attendance_corrections USING btree (user_id, created_at DESC);
...
CREATE TABLE attendance_events (
	...
	CONSTRAINT attendance_events_event_uuid_key UNIQUE (event_uuid),
	CONSTRAINT attendance_events_pkey PRIMARY KEY (id),
	CONSTRAINT attendance_events_attendance_log_id_fkey FOREIGN KEY (attendance_log_id) REFERENCES attendance_logs(id) ON DELETE SET NULL,
	CONSTRAINT attendance_events_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE SET NULL,
...
CREATE TABLE attendance_logs (
	...
	geo_flagged bool DEFAULT false NULL,
	CONSTRAINT attendance_logs_pkey PRIMARY KEY (id),
	CONSTRAINT attendance_logs_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE,
...
CREATE TABLE audit_logs (
	...
	created_at timestamptz DEFAULT now() NULL,
	CONSTRAINT audit_logs_pkey PRIMARY KEY (id),
	CONSTRAINT audit_logs_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE
);
ALTER TABLE public.audit_logs ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE availability (
	...
	created_at timestamptz DEFAULT now() NULL,
	CONSTRAINT availability_pkey PRIMARY KEY (id),
	CONSTRAINT availability_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE,
	CONSTRAINT availability_user_id_fkey FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE
);
CREATE INDEX idx_avail_branch ON public.availability USING btree (branch_id);
CREATE INDEX idx_avail_branch_week ON public.availability USING btree (branch_id, week_start);
CREATE INDEX idx_avail_user_week ON public.availability USING btree (user_id, week_start);
...
CREATE TABLE branch_settings (
	...
	settings jsonb DEFAULT '{}'::jsonb NULL,
	CONSTRAINT branch_settings_pkey PRIMARY KEY (branch_id),
	CONSTRAINT branch_settings_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE
);
ALTER TABLE public.branch_settings ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE branches (
	...
	created_at timestamptz DEFAULT now() NULL,
	CONSTRAINT branches_pkey PRIMARY KEY (id),
	CONSTRAINT branches_franchise_id_fkey FOREIGN KEY (franchise_id) REFERENCES franchises(id) ON DELETE SET NULL
);
CREATE INDEX idx_branches_franchise ON public.branches USING btree (franchise_id);
ALTER TABLE public.branches ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE certifications (
	...
	created_at timestamptz DEFAULT now() NULL,
	CONSTRAINT certifications_pkey PRIMARY KEY (id),
	CONSTRAINT certifications_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE,
...
CREATE TABLE checklists (
	...
	CONSTRAINT checklists_input_kind_chk CHECK ((input_kind = ANY (ARRAY['check'::text, 'number'::text]))),
	CONSTRAINT checklists_pkey PRIMARY KEY (id),
	CONSTRAINT checklists_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE,
	CONSTRAINT checklists_completed_by_fkey FOREIGN KEY (completed_by) REFERENCES users(id) ON DELETE SET NULL
);
CREATE INDEX idx_checklist_branch ON public.checklists USING btree (branch_id);
ALTER TABLE public.checklists ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE clock_overrides (
	...
	created_at timestamptz DEFAULT now() NOT NULL,
	CONSTRAINT clock_overrides_pkey PRIMARY KEY (id),
	CONSTRAINT clock_overrides_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE,
	CONSTRAINT clock_overrides_user_id_fkey FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE
);
CREATE INDEX idx_clock_overrides_user ON public.clock_overrides USING btree (user_id, expires_at);
ALTER TABLE public.clock_overrides ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE cover_requests (
	...
	created_at timestamptz DEFAULT now() NOT NULL,
	CONSTRAINT cover_requests_pkey PRIMARY KEY (id),
	CONSTRAINT cover_requests_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE,
	CONSTRAINT cover_requests_claimer_id_fkey FOREIGN KEY (claimer_id) REFERENCES users(id) ON DELETE SET NULL,
	CONSTRAINT cover_requests_requester_id_fkey FOREIGN KEY (requester_id) REFERENCES users(id) ON DELETE CASCADE
);
CREATE INDEX cover_requests_branch_status_idx ON public.cover_requests USING btree (branch_id, status);
CREATE INDEX cover_requests_requester_idx ON public.cover_requests USING btree (requester_id);
ALTER TABLE public.cover_requests ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE franchises (
	...
	created_at timestamptz DEFAULT now() NULL,
	CONSTRAINT franchises_pkey PRIMARY KEY (id),
	CONSTRAINT franchises_owner_fk FOREIGN KEY (owner_user_id) REFERENCES users(id) ON DELETE SET NULL
);
ALTER TABLE public.franchises ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE incidents (
	...
	created_at timestamptz DEFAULT now() NULL,
	CONSTRAINT incidents_pkey PRIMARY KEY (id),
	CONSTRAINT incidents_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE,
	CONSTRAINT incidents_reported_by_fkey FOREIGN KEY (reported_by) REFERENCES users(id) ON DELETE SET NULL
);
CREATE INDEX idx_incident_branch ON public.incidents USING btree (branch_id);
ALTER TABLE public.incidents ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE inventory_counts (
	...
	created_at timestamptz DEFAULT now() NULL,
	CONSTRAINT inventory_counts_pkey PRIMARY KEY (id),
	CONSTRAINT inventory_counts_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE
);
CREATE INDEX idx_inv_counts_branch ON public.inventory_counts USING btree (branch_id);
CREATE INDEX idx_inv_counts_date ON public.inventory_counts USING btree (count_date);
CREATE INDEX idx_inv_counts_prod ON public.inventory_counts USING btree (category, product);
...
CREATE TABLE inventory_master (
	...
	created_at timestamptz DEFAULT now() NULL,
	CONSTRAINT inventory_master_pkey PRIMARY KEY (id),
	CONSTRAINT inventory_master_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE
);
CREATE INDEX idx_inv_master_branch ON public.inventory_master USING btree (branch_id);
ALTER TABLE public.inventory_master ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE inventory_purchases (
	...
	created_at timestamptz DEFAULT now() NOT NULL,
	CONSTRAINT inventory_purchases_pkey PRIMARY KEY (id),
	CONSTRAINT inventory_purchases_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE
);
CREATE INDEX inventory_purchases_branch_date_idx ON public.inventory_purchases USING btree (branch_id, purchase_date);
CREATE INDEX inventory_purchases_branch_product_idx ON public.inventory_purchases USING btree (branch_id, product);
ALTER TABLE public.inventory_purchases ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE kiosks (
	...
	last_seen timestamptz NULL,
	CONSTRAINT kiosks_pkey PRIMARY KEY (id),
	CONSTRAINT kiosks_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE
);
ALTER TABLE public.kiosks ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE leave_requests (
	...
	created_at timestamptz DEFAULT now() NULL,
	CONSTRAINT leave_requests_pkey PRIMARY KEY (id),
	CONSTRAINT leave_requests_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE,
...
CREATE TABLE notifications (
	...
	created_at timestamptz DEFAULT now() NULL,
	CONSTRAINT notifications_pkey PRIMARY KEY (id),
	CONSTRAINT notifications_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE,
...
CREATE TABLE payroll_runs (
	...
	CONSTRAINT payroll_runs_pkey PRIMARY KEY (id),
	CONSTRAINT payroll_runs_status_check CHECK ((status = ANY (ARRAY['draft'::text, 'approved'::text]))),
	CONSTRAINT payroll_runs_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE
);
ALTER TABLE public.payroll_runs ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE payroll_settings (
	...
	updated_at timestamptz DEFAULT now() NOT NULL,
	CONSTRAINT payroll_settings_pkey PRIMARY KEY (branch_id),
	CONSTRAINT payroll_settings_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE
);
ALTER TABLE public.payroll_settings ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE performance_notes (
	...
	created_at timestamptz DEFAULT now() NULL,
	CONSTRAINT performance_notes_pkey PRIMARY KEY (id),
	CONSTRAINT performance_notes_author_fkey FOREIGN KEY (author) REFERENCES users(id) ON DELETE SET NULL,
	CONSTRAINT performance_notes_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE,
	CONSTRAINT performance_notes_user_id_fkey FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE
);
ALTER TABLE public.performance_notes ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE required_documents (
	...
	CONSTRAINT required_documents_branch_id_doc_type_key UNIQUE (branch_id, doc_type),
	CONSTRAINT required_documents_pkey PRIMARY KEY (id),
	CONSTRAINT required_documents_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE
);
ALTER TABLE public.required_documents ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE shift_broadcasts (
	...
	created_at timestamptz DEFAULT now() NULL,
	CONSTRAINT shift_broadcasts_pkey PRIMARY KEY (id),
	CONSTRAINT shift_broadcasts_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE,
	CONSTRAINT shift_broadcasts_created_by_fkey FOREIGN KEY (created_by) REFERENCES users(id) ON DELETE SET NULL
);
CREATE INDEX idx_broadcast_branch ON public.shift_broadcasts USING btree (branch_id);
ALTER TABLE public.shift_broadcasts ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE shift_templates (
	...
	created_at timestamptz DEFAULT now() NULL,
	CONSTRAINT shift_templates_pkey PRIMARY KEY (id),
	CONSTRAINT shift_templates_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE,
	CONSTRAINT shift_templates_created_by_fkey FOREIGN KEY (created_by) REFERENCES users(id) ON DELETE SET NULL
);
ALTER TABLE public.shift_templates ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE shift_times (
	...
	updated_at timestamptz DEFAULT now() NOT NULL,
	CONSTRAINT shift_times_pkey PRIMARY KEY (id),
	CONSTRAINT shift_times_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE
);
CREATE UNIQUE INDEX uq_shift_times_branch ON public.shift_times USING btree (branch_id, team, shift) WHERE (branch_id IS NOT NULL);
CREATE UNIQUE INDEX uq_shift_times_global ON public.shift_times USING btree (team, shift) WHERE (branch_id IS NULL);
ALTER TABLE public.shift_times ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE stock_batches (
	...
	created_at timestamptz DEFAULT now() NOT NULL,
	CONSTRAINT stock_batches_pkey PRIMARY KEY (id),
	CONSTRAINT stock_batches_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE,
	CONSTRAINT stock_batches_logged_by_fkey FOREIGN KEY (logged_by) REFERENCES users(id) ON DELETE SET NULL
);
CREATE INDEX stock_batches_branch_status_idx ON public.stock_batches USING btree (branch_id, status, expiry_date);
ALTER TABLE public.stock_batches ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE stock_transfers (
	...
	updated_at timestamptz DEFAULT now() NOT NULL,
	CONSTRAINT stock_transfers_pkey PRIMARY KEY (id),
	CONSTRAINT stock_transfers_from_branch_id_fkey FOREIGN KEY (from_branch_id) REFERENCES branches(id) ON DELETE CASCADE,
	CONSTRAINT stock_transfers_requested_by_fkey FOREIGN KEY (requested_by) REFERENCES users(id) ON DELETE SET NULL,
	CONSTRAINT stock_transfers_to_branch_id_fkey FOREIGN KEY (to_branch_id) REFERENCES branches(id) ON DELETE CASCADE
);
CREATE INDEX stock_transfers_from_idx ON public.stock_transfers USING btree (from_branch_id, status);
CREATE INDEX stock_transfers_to_idx ON public.stock_transfers USING btree (to_branch_id, status);
ALTER TABLE public.stock_transfers ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE swap_requests (
	...
	created_at timestamptz DEFAULT now() NULL,
	CONSTRAINT swap_requests_pkey PRIMARY KEY (id),
	CONSTRAINT swap_requests_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE,
	CONSTRAINT swap_requests_other_person_id_fkey FOREIGN KEY (other_person_id) REFERENCES users(id) ON DELETE SET NULL,
	CONSTRAINT swap_requests_requester_id_fkey FOREIGN KEY (requester_id) REFERENCES users(id) ON DELETE CASCADE
);
ALTER TABLE public.swap_requests ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE temp_logs (
	...
	recorded_at timestamptz DEFAULT now() NOT NULL,
	CONSTRAINT temp_logs_pkey PRIMARY KEY (id),
	CONSTRAINT temp_logs_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE,
	CONSTRAINT temp_logs_recorded_by_fkey FOREIGN KEY (recorded_by) REFERENCES users(id) ON DELETE SET NULL,
	CONSTRAINT temp_logs_unit_id_fkey FOREIGN KEY (unit_id) REFERENCES temp_units(id) ON DELETE CASCADE
);
CREATE INDEX temp_logs_branch_date_idx ON public.temp_logs USING btree (branch_id, work_date);
CREATE INDEX temp_logs_unit_idx ON public.temp_logs USING btree (unit_id, recorded_at DESC);
ALTER TABLE public.temp_logs ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE temp_units (
	...
	created_at timestamptz DEFAULT now() NOT NULL,
	CONSTRAINT temp_units_pkey PRIMARY KEY (id),
	CONSTRAINT temp_units_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE
);
CREATE INDEX temp_units_branch_idx ON public.temp_units USING btree (branch_id, is_active);
ALTER TABLE public.temp_units ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE users (
	...
	CONSTRAINT users_id_fkey FOREIGN KEY (id) REFERENCES users(id) ON DELETE CASCADE
);
CREATE INDEX idx_users_branch ON public.users USING btree (branch_id);
...
CREATE TABLE waste_log (
	...
	created_at timestamptz DEFAULT now() NOT NULL,
	CONSTRAINT waste_log_pkey PRIMARY KEY (id),
	CONSTRAINT waste_log_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE,
	CONSTRAINT waste_log_logged_by_fkey FOREIGN KEY (logged_by) REFERENCES users(id) ON DELETE SET NULL
);
CREATE INDEX waste_log_branch_date_idx ON public.waste_log USING btree (branch_id, work_date);
ALTER TABLE public.waste_log ENABLE ROW LEVEL SECURITY;
...
CREATE TABLE weekly_roster (
	...
	created_at timestamptz DEFAULT now() NULL,
	CONSTRAINT weekly_roster_pkey PRIMARY KEY (id),
	CONSTRAINT weekly_roster_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES branches(id) ON DELETE CASCADE
);
CREATE INDEX idx_roster_branch ON public.weekly_roster USING btree (branch_id);
CREATE INDEX idx_roster_branch_week ON public.weekly_roster USING btree (branch_id, week_start);
ALTER TABLE public.weekly_roster ENABLE ROW LEVEL SECURITY;
