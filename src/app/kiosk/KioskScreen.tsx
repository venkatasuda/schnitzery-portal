...
export default function KioskScreen() {
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        background: "radial-gradient(circle at 50% 0%, ***REMOVED***2a1414, ***REMOVED***160c0c 70%)",
        color: "***REMOVED***fff",
        display: "flex",
    ...
    >
      <div style={{ color: "***REMOVED***d4a847", fontSize: 22, fontWeight: 700, fontFamily: "Georgia, serif", letterSpacing: 0.5 }}>
        Schnitzery
      </div>
      <h1 style={{ fontSize: 34, fontWeight: 800, margin: "6px 0 2px", fontFamily: "Georgia, serif" }}>
        {t("kiosk.title")}
      </h1>
      <p style={{ color: "***REMOVED***b8a9a9", fontSize: 15, margin: "0 0 28px", maxWidth: 460, lineHeight: 1.4 }}>
        {t("kiosk.hint")}
      </p>

      {error ? (
        <div style={{ color: "***REMOVED***ec7063", fontSize: 18, padding: 40 }}>{error}</div>
      ) : (
        <>
          <div
            style={{
          ...
          >
            {qrImg ? (
              ...
              <div style={{ width: 300, height: 300, background: "***REMOVED***eee", borderRadius: 12 }} />
            )}
          </div>

          <div style={{ fontSize: 14, letterSpacing: 3, color: "***REMOVED***9a8f8f", marginBottom: 8 }}>
            {t("cd.orEnterCode")}
          </div>
          <div
            style={{
          ...
          <div style={{ width: 320, maxWidth: "80vw", marginTop: 28 }}>
            ...
            <div style={{ fontSize: 13, color: "***REMOVED***9a8f8f", marginTop: 10 }}>
