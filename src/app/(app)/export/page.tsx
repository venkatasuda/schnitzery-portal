    ...
    <div className="fade-up">
        ...
        <div className="card" style={{ padding: 0, overflow: "hidden" }}>
          ...
          {rows.map((r, i) => (
            <div key={i} style={{ display: "grid", gridTemplateColumns: "1.6fr 0.7fr 0.6fr 0.7fr 0.9fr", gap: 8, padding: "11px 14px", fontSize: 13, alignItems: "center", borderBottom: i < rows.length - 1 ? "1px solid rgba(128,128,128,0.08)" : "none" }}>
              ...
              <span style={{ textAlign: "right", color: r.wage == null ? "***REMOVED***e8a35a" : "var(--gray)" }}>{r.wage == null ? "set" : eur(r.wage)}</span>
      ...
      {rows.some((r) => r.wage == null) && (
        <div style={{ fontSize: 12, color: "var(--gray)", marginTop: 10 }}>
          Rows marked <span style={{ color: "***REMOVED***e8a35a" }}>set</span> have no hourly wage yet — add it on the <Link href="/labor" style={{ color: "var(--gold)", textDecoration: "none" }}>Labor</Link> page and their gross will fill in.
        </div>
      )}
