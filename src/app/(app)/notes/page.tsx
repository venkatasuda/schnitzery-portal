...
export default function NotesPage() {
  ...
  return (
    <div style={{ maxWidth: 600, margin: "0 auto" }}>
      ...
      <p style={{ color: "#9a8f8f", fontSize: 13, marginBottom: 16 }}>Track performance notes and recognise great work.</p>
      ...
      {loading ? <div style={{ color: "#9a8f8f", padding: 20, textAlign: "center" }}>Loading…</div>
      : shown.length === 0 ? <div style={{ ...card, textAlign: "center", color: "#9a8f8f", padding: 30 }}>No notes yet.</div>
      : shown.map((n) => (
