...
export default function ExpiringDocsPage() {
  ...
  function statusOf(days: number) {
    ...
    if (days === 0) return { label: "Expires today", color: "***REMOVED***ec7063" };
    return { label: `Expires in ${days}d`, color: days <= 30 ? "***REMOVED***ec7063" : "***REMOVED***e8a35a" };
  }
    ...
    <div className="fade-up">
      ...
      {loading ? (
        ...
        <div className="card" style={{ textAlign: "center", padding: 32 }}>
          ...
          <div style={{ color: "***REMOVED***58d68d", fontSize: 15, fontWeight: 700 }}>Nothing expiring</div>
