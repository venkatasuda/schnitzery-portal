            ...
            <div className="hub-tab-panel active">
              ...
              <div className="card">
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10 }}>
                  ...
                  <Mini label="Submissions" value={`${ov?.submissionCount ?? 0}/${ov?.staffCount ?? 0}`} color={(ov?.submissionCount ?? 0) > 0 ? "***REMOVED***58d68d" : "***REMOVED***ec7063"} />
                  <Mini label="Status" value={ov?.rosterExists ? "Built" : "Open"} color={ov?.rosterExists ? "***REMOVED***58d68d" : "***REMOVED***e8a35a"} />
                </div>
              </div>
          ...
          {tab === "insights" && (
            <div className="hub-tab-panel active">
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 12 }}>
                ...
                <Mini label="Submissions" value={`${ov?.submissionCount ?? 0}/${ov?.staffCount ?? 0}`} color="***REMOVED***58d68d" />
              </div>
                ...
                <>
                  <div className="card">
                    ...
                    {(ov?.byTeamArr || []).map((t: any) => (
                      <BarRow key={t.team} label={t.team} count={t.count} max={ov.totalShifts} color="***REMOVED***3498db" />
                    ))}
                  </div>
                  <div className="card">
                  ...
                  <div className="card">
                    ...
                    {(ov?.byDayArr || []).map((d: any) => (
                      <BarRow key={d.day} label={d.day} count={d.count} max={Math.max(1, ...(ov.byDayArr || []).map((x: any) => x.count))} color="***REMOVED***d4a847" />
                    ))}
                  </div>
                </>
              )}
            ...
            <div className="hub-tab-panel active">
              {(ov?.conflicts || []).length === 0 ? (
                <div className="card" style={{ textAlign: "center", padding: 28 }}>
                  ...
                  <div style={{ color: "***REMOVED***58d68d", fontSize: 14, fontWeight: 600 }}>No conflicts</div>
