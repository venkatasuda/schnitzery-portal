...
export default function InventoryPage() {
  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto" }}>
      ...
      <p style={{ color: "***REMOVED***9a8f8f", fontSize: 13, marginBottom: 16 }}>Stock counts by date · low-stock alerts.</p>
      ...
      {loading ? (
        ...
        <>
          ...
          <div style={{ ...card, marginBottom: 14, borderColor: lowStock.length ? "rgba(231,76,60,0.3)" : "rgba(255,255,255,0.08)" }}>
            ...
            {lowStock.map((l, i) => (
              <div key={i} style={{ display: "flex", justifyContent: "space-between", padding: "7px 0", borderBottom: "1px solid rgba(255,255,255,0.05)", fontSize: 13 }}>
                ...
                <span style={{ color: "***REMOVED***ec7063" }}>{l.ist}/{l.soll} {l.unit || ""} · short {l.short}</span>
              </div>
            ))}
          </div>
          ...
          {/* CATEGORY TABS */}
          {categories.length === 0 ? (
            <div style={{ ...card, textAlign: "center", color: "***REMOVED***9a8f8f", padding: 30 }}>No products yet. Add some to the catalog above.</div>
          ) : (
            <>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12 }}>
                      <div style={{ flex: 1 }}>
                        ...
                        <div style={{ fontSize: 12, color: "***REMOVED***9a8f8f" }}>
                          ...
                          {counted && <span style={{ color: isLow ? "***REMOVED***ec7063" : "***REMOVED***58d68d" }}> · Counted: {counted.ist}</span>}
                        </div>
                      </div>
