...
export default function ClockDisplayPage() {
  ...
  return (
    <div style={{ maxWidth: 520, margin: "0 auto", textAlign: "center" }}>
      ...
      <p style={{ color: "***REMOVED***9a8f8f", fontSize: 13, marginBottom: 24 }}>
        {t("cd.subtitle")}
      </p>

      <div style={{ background: "***REMOVED***241414", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 20, padding: 32 }}>
        {error ? (
          <div style={{ color: "***REMOVED***ec7063", padding: 30 }}>{error}</div>
        ) : (
          <>
            {/* QR */}
            <div style={{ display: "flex", justifyContent: "center", marginBottom: 24 }}>
              {qrImg ? (
                <img src={qrImg} alt="Clock QR" style={{ width: 260, height: 260, borderRadius: 16, background: "***REMOVED***fff", padding: 8 }} />
              ) : (
            ...
            {/* CODE */}
            <div style={{ fontSize: 13, letterSpacing: 2, color: "***REMOVED***9a8f8f", marginBottom: 6 }}>{t("cd.orEnterCode")}</div>
            <div style={{ fontSize: 56, fontWeight: 700, letterSpacing: 8, color: "***REMOVED***d4a847", fontFamily: "Georgia, serif" }}>
              {code}
            </div>
            ...
            <div style={{ marginTop: 20 }}>
              <div style={{ height: 6, background: "rgba(255,255,255,0.08)", borderRadius: 4, overflow: "hidden" }}>
                <div style={{ height: "100%", width: `${pct}%`, background: "***REMOVED***d4a847", transition: "width 1s linear" }} />
              </div>
              <div style={{ fontSize: 12, color: "***REMOVED***9a8f8f", marginTop: 8 }}>
      ...
      <p style={{ fontSize: 11, color: "***REMOVED***6f6565", marginTop: 16 }}>
