                ...
                return (
                  <div key={r.id} style={{ display: "flex", alignItems: "center", gap: 12, padding: "11px 8px", borderBottom: i < filtered.length - 1 ? "1px solid rgba(128,128,128,0.12)" : "none" }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontSize: 14, fontWeight: 600, color: "var(--white)" }}>{r.name}{r.late_mins > 0 && <span style={{ fontSize: 10, color: "***REMOVED***ec7063", marginLeft: 8 }}>⚠ {t("ahub.mLate", { n: r.late_mins })}</span>}</div>
              ...
              <div key={r.id} className="card" style={{ marginBottom: 8 }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
                  <div style={{ fontSize: 14, fontWeight: 600, color: "var(--white)" }}>
                    {r.name}
                    {r.overtime && <span style={{ fontSize: 10, color: "***REMOVED***e8a35a", marginLeft: 8 }}>⏱ {t("approvals.overtime")}</span>}
                    {r.late_mins > 0 && <span style={{ fontSize: 10, color: "***REMOVED***ec7063", marginLeft: 8 }}>⚠ {t("ahub.mLate", { n: r.late_mins })}</span>}
                  </div>
