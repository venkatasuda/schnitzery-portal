...
export default function AuditPage() {
  ...
  return (
    <div style={{ maxWidth: 620, margin: "0 auto" }}>
      ...
      <p style={{ color: "***REMOVED***9a8f8f", fontSize: 13, marginBottom: 16 }}>Recent activity on your branch.</p>

      {loading ? (
        <div style={{ color: "***REMOVED***9a8f8f", padding: 30, textAlign: "center" }}>Loading…</div>
      ) : logs.length === 0 ? (
        <div style={{ ...card, textAlign: "center", color: "***REMOVED***9a8f8f", padding: 30 }}>No activity logged yet.</div>
      ) : (
        logs.map((l) => (
          <div key={l.id} style={{ ...card, marginBottom: 8, padding: 14, display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12 }}>
            <div>
              ...
              <div style={{ fontSize: 11, color: "***REMOVED***6f6565", marginTop: 2 }}>by {l.actor || "—"}</div>
            </div>
