          ...
          <>
            ...
            {!clockedIn ? (
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                <button onClick={() => doAction(clockIn, t("att.clockedIn"), "clock_in")} disabled={working} style={bigBtn("linear-gradient(135deg,***REMOVED***1e8449,***REMOVED***27ae60)", working)}>{t("att.clockInNow")}</button>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                {!onBreak ? (
                  <button onClick={() => doAction(startBreak, t("att.breakStarted"), "break_start")} disabled={working} style={bigBtn("linear-gradient(135deg,***REMOVED***b9770e,***REMOVED***e67e22)", working)}>{t("att.startBreak")}</button>
                ) : (
                  <button onClick={() => doAction(endBreak, t("att.breakEnded"), "break_end")} disabled={working} style={bigBtn("linear-gradient(135deg,***REMOVED***117a65,***REMOVED***16a085)", working)}>{t("att.endBreak")}</button>
                )}
                <button onClick={() => doAction(clockOut, t("att.clockedOut"), "clock_out")} disabled={working || onBreak} style={bigBtn("linear-gradient(135deg,***REMOVED***922b21,***REMOVED***c0392b)", working || onBreak)}>{t("att.clockOut")}</button>
                {!onBreak && (
                  <div style={{ display: "flex", gap: 8 }}>
