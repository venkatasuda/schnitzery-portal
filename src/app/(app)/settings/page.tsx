...
export default function SettingsPage() {
  ...
  return (
    <div style={{ maxWidth: 520, margin: "0 auto" }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, fontFamily: "Georgia, serif", marginBottom: 2, display: "flex", alignItems: "center", gap: 8 }}><Icon e="⚙️" size={22} /> {t("profile.branchSettings")}</h1>
      <p style={{ color: "***REMOVED***9a8f8f", fontSize: 13, marginBottom: 18 }}>{t("set.subtitle")}</p>

      {loading ? (
        <div style={{ color: "***REMOVED***9a8f8f", padding: 30, textAlign: "center" }}>{t("common.loading")}</div>
      ) : (
        <>
          <div style={{ ...card, marginBottom: 12 }}>
            <label style={{ display: "flex", justifyContent: "space-between", alignItems: "center", cursor: "pointer" }}>
              <div>
                ...
                <div style={{ fontSize: 12, color: "***REMOVED***9a8f8f", marginTop: 2 }}>{t("set.qrSub")}</div>
              </div>
          ...
          <div style={{ ...card, marginBottom: 12 }}>
            ...
            <div style={{ fontSize: 12, color: "***REMOVED***9a8f8f", marginBottom: 10 }}>{t("set.gpsSub")}</div>
          ...
          <div style={{ ...card, marginTop: 16, fontSize: 12, color: "***REMOVED***6f6565" }}>
            {t("set.note")}
          </div>

          <div style={{ marginTop: 20, marginBottom: 8, fontSize: 12, fontWeight: 700, letterSpacing: 0.5, color: "***REMOVED***9a8f8f", textTransform: "uppercase" }}>{t("set.devicesLocation")}</div>
