  ...
  return (
    <>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10, marginBottom: 14 }}>
        ...
        <Stat value={s.openIncidents} label="Incidents" color={s.openIncidents > 0 ? "***REMOVED***ec7063" : "var(--white)"} />
        <Stat value={s.lowStock} label="Low Stock" color={s.lowStock > 0 ? "***REMOVED***e8a35a" : "var(--white)"} />
        <Stat value={`${s.checklistDone}/${s.checklistTotal}`} label="Checklist" color={s.checklistTotal > 0 && s.checklistDone === s.checklistTotal ? "***REMOVED***58d68d" : "var(--white)"} />
      </div>

      <div className="section-label">Manage</div>
      <Shortcut href="/dashboard" icon="🔴" grad="linear-gradient(135deg,***REMOVED***922b21,***REMOVED***c0392b)" title="Live Attendance" sub="Who's working, on break, completed" />
      <Shortcut href="/roster" icon="📋" grad="linear-gradient(135deg,***REMOVED***1a6b8a,***REMOVED***3498db)" title="Weekly Roster" sub="Build & publish the schedule" />
      <Shortcut href="/approvals" icon="✅" grad="linear-gradient(135deg,***REMOVED***1e8449,***REMOVED***27ae60)" title="Approvals" sub="Leave & swap requests" />
      <Shortcut href="/people-hub" icon="👥" grad="linear-gradient(135deg,***REMOVED***6b2fa0,***REMOVED***9b59b6)" title="People & Team" sub="Staff, directory & notes" />
      <Shortcut href="/announcements" icon="📣" grad="linear-gradient(135deg,***REMOVED***b9770e,***REMOVED***e67e22)" title="Post Announcement" sub="Send news to all staff" />
      <Shortcut href="/settings-hub" icon="⚙️" grad="linear-gradient(135deg,***REMOVED***555,***REMOVED***777)" title="Settings" sub="Config, reports & tools" />
    </>
  );
}
