    ...
    <div className="fade-up">
      ...
      {myExpiring.length > 0 && (
        <div className="card" style={{ borderColor: "rgba(231,76,60,0.4)", background: "rgba(231,76,60,0.08)", marginBottom: 14 }}>
          <div style={{ fontWeight: 700, color: "***REMOVED***ec7063", fontSize: 14, marginBottom: 4 }}>⚠️ {t("home.docsNeedAttention")}</div>
  ...
  return (
    <>
      ...
      <Link href="/branches" className="feature-card">
        <div className="feature-icon" style={{ background: "linear-gradient(135deg,***REMOVED***6b2fa0,***REMOVED***9b59b6)" }}>🗂️</div>
        <div style={{ flex: 1 }}>
      ...
      <Shortcut href="/settings-hub" icon="⚙️" grad="linear-gradient(135deg,***REMOVED***555,***REMOVED***777)" title={t("home.settings")} sub={t("home.settingsSub")} />
    </>
  );
}
