  ...
  return (
    <>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10, marginBottom: 14 }}>
        <TileLink href="/attendance-hub" value={s.clockedIn} label="Working Now" color="***REMOVED***58d68d" />
        <TileLink href="/staff" value={s.staffCount} label="Team Size" color="var(--white)" />
        <TileLink href="/approvals" value={s.pendingApprovals} label="Approvals" color={s.pendingApprovals > 0 ? "***REMOVED***e8a35a" : "var(--white)"} />
        <TileLink href="/incidents" value={s.openIncidents} label="Incidents" color={s.openIncidents > 0 ? "***REMOVED***ec7063" : "var(--white)"} />
        <TileLink href="/inventory" value={s.lowStock} label="Low Stock" color={s.lowStock > 0 ? "***REMOVED***e8a35a" : "var(--white)"} />
        <TileLink href="/checklist" value={`${s.checklistDone}/${s.checklistTotal}`} label="Checklist" color={s.checklistTotal > 0 && s.checklistDone === s.checklistTotal ? "***REMOVED***58d68d" : "var(--white)"} />
      </div>
