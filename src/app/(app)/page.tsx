...
function ManagerDash({ stats }: { stats: { clockedIn: number; staffCount: number; pendingApprovals: number; openIncidents: number; lowStock: number; checklistDone: number; checklistTotal: number } | null }) {
  ...
  return (
    <>
      ...
      <Shortcut href="/staff" icon="👥" grad="linear-gradient(135deg,***REMOVED***6b2fa0,***REMOVED***9b59b6)" title="Staff Management" sub="Your team & accounts" />
...
function OwnerDash({ stats }: { stats: { clockedIn: number; staffCount: number; pendingApprovals: number; openIncidents: number; lowStock: number; checklistDone: number; checklistTotal: number } | null }) {
  ...
  return (
    <>
      ...
      <Shortcut href="/staff" icon="👥" grad="linear-gradient(135deg,***REMOVED***922b21,***REMOVED***c0392b)" title="Staff Management" sub="Manage team & create accounts" />
      ...
      <Shortcut href="/export" icon="📤" grad="linear-gradient(135deg,***REMOVED***117a65,***REMOVED***16a085)" title="Payroll Export" sub="Hours per staff + CSV" />
      <Shortcut href="/settings" icon="⚙️" grad="linear-gradient(135deg,***REMOVED***555,***REMOVED***777)" title="Settings" sub="Branch configuration" />
    </>
  );
}
