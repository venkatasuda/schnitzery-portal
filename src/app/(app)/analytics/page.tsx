    ...
    <div className="fade-up">
      ...
      {loading ? (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10, marginBottom: 16 }}>
          ...
          <Stat value={`${data.lateRate}%`} label={t("ana.lateRate")} color={data.lateRate > 15 ? "***REMOVED***ec7063" : "***REMOVED***58d68d"} />
        </div>
      )}
          ...
          <ChartCard title={t("ana.hoursPerWeek")}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data.weekly} margin={{ top: 6, right: 6, bottom: 0, left: -22 }}>
                ...
                <XAxis dataKey="week" tick={{ fontSize: 11, fill: "***REMOVED***9a8f8f" }} tickLine={false} axisLine={false} />
...
const tooltip = {
  ...
  labelStyle: { color: "***REMOVED***fff" },
  itemStyle: { color: "***REMOVED***d4a847" },
